...
GITHUB ROOT FILE LAYOUT — CURRENT FINAL
Upload all these directly to repository root:
FINAL_SETUP_CHECKLIST.txt
README.txt
README_FIREBASE_SETUP.txt
app.js
firebase-config.js
firestore.rules
icon-192.svg
...
There is NO /icons folder in this edition.
index.html, manifest.webmanifest and service-worker.js all point to root icon files.
